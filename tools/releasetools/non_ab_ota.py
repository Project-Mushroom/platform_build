...
""" % bcb_dev)
  ...
  # Here's Miku UI ASCII Art
  # Get prop
  mikuver = target_info.GetBuildProp("ro.miku.version")
  ...
  script.Print("             ,k00000000000o.")
  script.Print("            .d000000000xlk0o.")
  script.Print("            c00kxxO000x'.l00o.")
  script.Print("           ,kKk:,cx000kl.,k00o.")
  script.Print("          .d00kxk0000000:.o000d.")
  script.Print("          c000000000000O; ,O000d.")
  script.Print("         ,k000000000OkOO; .o0000d.")
  script.Print("        .x00000000kc.;x0:  ;O0000d.")
  script.Print("       .o00000000Kk, 'xKl  .d00000d.")
  script.Print("      .l00000000000xllkKx.  :O00000d.")
  script.Print("      :O0000000000000000O:  .x000000l.")
  script.Print("     ,k000000000000000000d.  c000000O:")
  script.Print("    'x0000000000000kox000O;  ,O00000Kx'")
  script.Print("   ,x00000000kl:d00OxkO000c  .x0000000:")
  script.Print("  ,k000000000l. .x00Kx:;:,.  .d0000000o.")
  script.Print(" 'x0000000000:   ;OKKO;      .x0000000d.")
  script.Print(".l0000000000O,   .o000l.     ;O000000Kx.")
  script.Print(",k0000000000O,    ;O0Kx'    .o00000000l.")
  script.Print(":000000000000:    .o00O;    ;O0000000x'")
  script.Print("c0000000000Ol;.    'cx0d.  .x0000000O;")
  script.Print(";O00000000k,  .      ,x0o. :0000000O:")
  script.Print(".l00000000c           'x0l.,dk000Oo'")
  script.Print(" .;xO0Odkk'            .xO: .,xOl'")
  script.Print("   .,ol:xd.             ,kx.  ''")
  script.Print("       'xk'             .l0c")
  script.Print("       .d0l.            .d0x'")
  script.Print("       .l0k,            ,k0d.")
  script.Print("        .;,.            .,;.  ")
  script.Print("███    ███ ██ ██   ██ ██    ██     ██    ██ ██")
  script.Print("████  ████ ██ ██  ██  ██    ██     ██    ██ ██")
  script.Print("██ ████ ██ ██ █████   ██    ██     ██    ██ ██")
  ...
  script.Print("██      ██ ██ ██   ██  ██████       ██████  ██")
  script.Print("----------------------------------------------")
  script.Print("Hey~Nice to meet you! | 呀，你来啦！ ")
  script.Print("-")
  script.Print("You are installing Miku UI %s based on Android %s"%(mikuver,androidver))
  script.Print("你正在安装基于Android %s的Miku UI %s~"%(androidver,mikuver))
  script.Print("-")
  script.Print("Build date...let me see.. emm %s"%(builddate))
  script.Print("这个Miku UI是在%s的时候编译出来的哦"%(builddate))
  script.Print("-")
  script.Print("Well...The device you are using is %s %s, right?"%(manufacturer,pmodel))
  script.Print("嗯...你正在用的是来自%s的%s...对吧？只是确认一下~"%(manufacturer,pmodel))
  script.Print("-")
  script.Print("If you have any issue about Miku UI, just contact %s QwQ"%(builder))
  script.Print("这个Miku UI的编译者是%s.有问题请去找Ta哦！QwQ"%(builder))
  script.Print("----------------------------------------------")
  script.Print("Just sit down, and enjoy a VOCALOID song~")
  script.Print("接下来就请坐下来听一首V家曲吧~")
  script.Print("----------------------------------------------")
